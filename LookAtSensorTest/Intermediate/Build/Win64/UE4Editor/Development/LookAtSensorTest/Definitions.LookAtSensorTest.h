...
#define UE_PROJECT_NAME LookAtSensorTest
#define UE_TARGET_NAME LookAtSensorTestEditor
#define UE_MODULE_NAME "LookAtSensorTest"
...
#define LOOKATSENSORTEST_API DLLEXPORT
